...
mongoose.connect("mongodb+srv://ajithra:ajithra@cluster000.hjf3qzh.mongodb.net/EmployeeDB?retryWrites=true&w=majority"),
...
app.listen(3000, ()=>{
    console.log("Server Connecetd to Port 3000");
});
